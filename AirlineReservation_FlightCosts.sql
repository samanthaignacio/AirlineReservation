...
--
-- Dumping data for table `FlightCosts`
--

LOCK TABLES `FlightCosts` WRITE;
/*!40000 ALTER TABLE `FlightCosts` DISABLE KEYS */;
INSERT INTO `FlightCosts` VALUES (1,50,'economy',1);
/*!40000 ALTER TABLE `FlightCosts` ENABLE KEYS */;
UNLOCK TABLES;
